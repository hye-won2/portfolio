...
function pauseAnimations() {
    document.querySelectorAll('.your-animation-class').forEach(function (element) {
...
$('#menuBtn').click(function () {
    ...
    if (menuWrap.hasClass('on')) {
        ...
        $('#menuBtn').attr('src', 'images/menu_bar_m.png').removeClass('btnRotate');

        // 애니메이션 다시 시작
        $('.your-animation-class').css('animation-play-state', 'running');
    } else {
        // 메뉴가 열리는 경우
        menuWrap.addClass('on');
        $('#menuBtn').attr('src', 'images/menu_close_m.png').addClass('btnRotate');

        // 애니메이션 일시정지
        $('.your-animation-class').css('animation-play-state', 'paused');
    }
});